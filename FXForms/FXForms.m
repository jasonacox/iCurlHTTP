...
static const CGFloat FXFormFieldPaddingLeft = 10; // 10
static const CGFloat FXFormFieldPaddingRight = 10; // 10
static const CGFloat FXFormFieldPaddingTop = 6; // 12
static const CGFloat FXFormFieldPaddingBottom = 6;  // 12
...
- (void)update
{
    ...
    else if ([self.field.type isEqualToString:FXFormFieldTypeLongText])
    {
        self.textView.autocorrectionType = UITextAutocorrectionTypeNo;
        self.textView.autocapitalizationType = UITextAutocapitalizationTypeNone;
